...
export class TrajectoryGenerator {
   ...
   */
  static expandBounds(bounds: MapBounds, marginPercent: number = 0.1): MapBounds {
   ...
   */
  static calculateZoomLevel(bounds: MapBounds, mapSize: { width: number; height: number }): number {

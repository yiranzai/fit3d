...
export class MapRenderer {
     ...
     */
    static async renderTrajectory(trajectoryData, options) {
        try {
     ...
     */
    static generateTileUrls(bounds, zoom, style) {
        const urls = [];
        // 计算瓦片范围
     ...
     */
    static async simulateMapRendering(tileUrls, trajectoryData, options) {
        console.log('🎨 开始渲染地图...');
        // 模拟下载瓦片
     ...
     */
    static expandBounds(bounds, marginPercent) {

 ...
 */
export const CHINESE_MAP_PROVIDERS = {
    amap: {
        id: 'amap',
        name: '高德地图',
        nameEn: 'Amap',
 ...
 * 获取中国地图提供商列表
 */
export function getChineseMapProviders() {
    return Object.values(CHINESE_MAP_PROVIDERS);
}
/**
 * 根据ID获取中国地图提供商
 */
export function getChineseMapProvider(id) {
 ...
 * 生成地图瓦片URL
 */
export function generateTileUrl(provider, x, y, z, apiKey) {
...
//# sourceMappingURL=chinese-map-providers.js.map